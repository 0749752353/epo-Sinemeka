    ...
    <header>
      <nav className="border-b-2 bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          {/* Icon Group: Left (dark mode) and Right (search, hamburger) */}
          <div className="flex justify-between items-center w-full md:w-auto md:order-2">
            {/* Left: Dark mode toggle */}
            <div className="md:mr-4">
              <button
                onClick={() => setDarkMode(!darkMode)}
                type="button"
                className="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-600 rounded-lg text-sm p-2.5 flex items-center gap-2"
              >
                {darkMode ? "Light" : "Dark"}
                <svg
            ...
            {/* Right: Search icon, search input (desktop), and hamburger menu */}
