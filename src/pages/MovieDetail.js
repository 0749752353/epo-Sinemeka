...
export const MovieDetail = () => {
  ...
  useEffect(() => {
    async function fetchMovie() {
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=a2436fd216043cfa7767db678d841373`);
  ...
  useEffect(() => {
    document.title = `${movie.title} | Sinemeka`;
  });
  ...
  return (
    ...
    <p className="text-4xl font-bold my-3 text-center lg:text-left">{movie.title}</p>
